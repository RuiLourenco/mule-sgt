viewsh = 17;
viewsv = 17;
input2 = '/nfs/home/ruilourenco.it/Documents/Code/Mule_Slant/LightFields/Tarot/';
...
for rate = rates    
    ...
    total_psnr_y = 0;
    total_ssim = 0;
    file = dir(sprintf('../tarot_%.3g.comp',rate))
    filesize = file.bytes * 8; % File size in bits
    true_rate = filesize/(viewsh*viewsv * 1024 * 1024);
    for s = 0:(viewsh-1)
        for t = 0:(viewsv-1)
