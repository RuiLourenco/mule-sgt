...
TEST(DebugInfoTests,LoadAndPrint){
    ...
    string inputDirectory1 = "/nfs/home/ruilourenco.it/Documents/Code/mule-sgt-structure-tensor/results/Tarot/";
    string inputDirectory =  "/nfs/home/ruilourenco.it/Documents/Code/mule-sgt-structure-tensor/results/Tarot/";
    string inputInfo = inputDirectory +   "tarot_0.75_variable_rhoAngleSpace_info.json";
    string inputInfo1 = inputDirectory1 + "tarot_0.75_variable_rhoAngleSpace_info.json";
    std::array<int64_t,2> size = {1024,1024};
    cout<<inputInfo<<endl;
    ...
    at::Tensor rhoU = CodingPartitionInfo::getChosenRhoU(codingPartitionInfos,size);
    at::Tensor rhoS = CodingPartitionInfo::getChosenRhoS(codingPartitionInfos,size);
    at::Tensor rhoRatio = rhoS/ rhoU;
    ...
    write_tensor(st,inputDirectory + "st.png");
    write_tensor(rhoU,inputDirectory + "rhoU.png");
    write_tensor(rhoS,inputDirectory + "rhoS.png");
    write_tensor(rhoRatio,inputDirectory + "rhoRatio.png",{0.5,1});
