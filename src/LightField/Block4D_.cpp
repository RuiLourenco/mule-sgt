...
at::Tensor Block4D_::getTransformMatrix(const at::Tensor& cov, bool isHorizontal, at::Tensor& eigVals) const{
...
at::Tensor Block4D_::matrixTransform(const at::Tensor& flatBlock,const at::Tensor& sgtMatrixH, const at::Tensor& sgtMatrixV,const at::Tensor& eigValsH,const at::Tensor& eigValsV) {
...
at::Tensor Block4D_::iMatrixTransform(const at::Tensor& flatBlock,const at::Tensor& sgtMatrixH, const at::Tensor& sgtMatrixV) {
